...
public class GooglemapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private SupportMapFragment mapFragment;//전역변수 설정
...
//        mapFragment.getMapAsync(this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(markerOptions);//셋팅한 마커옵션 추가

        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(location, 16));//숫자 키울수록 확대해서 보임
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(location, 16));//애니메이션효과
